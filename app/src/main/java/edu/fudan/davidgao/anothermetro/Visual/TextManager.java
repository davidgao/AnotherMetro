...
public class TextManager {
    ...
    public TextManager(TextObject text, float ssu)
    {
        ...
        // Text shader
        int vshadert = loadShader(GLES20.GL_VERTEX_SHADER,
                vs_Text);
        int fshadert = loadShader(GLES20.GL_FRAGMENT_SHADER,
                fs_Text);

        mProgram = GLES20.glCreateProgram();
        GLES20.glAttachShader(mProgram, vshadert);
        GLES20.glAttachShader(mProgram, fshadert);
    ...
    public void Draw(float[] m)
    {
        ...
        int mColorHandle = GLES20.glGetAttribLocation(mProgram,
        "a_Color");
